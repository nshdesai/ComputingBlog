title: Simulating Self Driving Cars in a web browser
subtitle: Using Tensorflow.js to simulate autonomous driving
...
This is an attempt to simulate how self-driving cars work (all done in the browser).
Concepts from Reinforcement Learing will be used heavily to write some of the code in this
post (you can read it [here](bcc.bethuenci.com/posts/introtoRL)).

### Setting up the enviroment
----

We will be using the `Metacar` module to simulate the road environment. Here's how you do it...
...
Here is the entire snippet to write the `PolicyAgent()` used
...
### Modify the actions we can perform on the environment
----

These actions will be done endlessly...
...
Setup the environment to handle all the actions we require
